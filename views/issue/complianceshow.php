        ...
        <div class="portlet">
            <div class="portlet-title">
                 <div class="caption cap-head">
                    ...
                    <a href="/issue/complianceIssue">合规通知列表&nbsp;&nbsp;<i class="icon-angle-right"></i></a>
                    <a href="#">处理合规通知</a>
                 </div>
                <div class="tools">
        ...
        <div class="col-md-9">
            <div class="portlet">
                <div class="portlet-body">
                    <h4><strong>#<?php echo $issue->id . ' 合规通知 ' . $issue->name; ?></strong></h4>
                    <hr/>
                    ...
                    <div class="form">
                        <form role="form" action="/issue/processCompliance" id="fileupload" method="POST"
                              enctype="multipart/form-data" class="form-horizontal">
                            <div class="form-group">
                                <label class="col-md-2 control-label"><strong>回复<span
            ...
            <div class="portlet sale-summary">
                <div class="portlet-body">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <span class="sale-info">
                               受理公司 <i class="fa fa-img-up"></i>
                            </span>
                            <span class="sale-num">
                               <?php echo Service::get_company_name_by_id($issue->assignee_company_id);?>
                            </span>
                        </li>

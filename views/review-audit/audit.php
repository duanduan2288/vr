        ...
        <div class="portlet">
            <div class="portlet-title">
                <div class="caption cap-head">
                    ...
                    <a href="/review-audit/index">域名复审</a>
                </div>
                <div class="tools">
                ...
                <form role="form" class="form-horizontal" >
                    <div class="form-wizard">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">域名到期时间:</label>
                                <div class="col-md-4">
                                    <p class="form-control-static">
                                        <?php echo isset($auditdata['service_end_time'])?$auditdata['service_end_time']:'';?>
                                    </p>
                                </div>
                            </div>
                            <div class="form-group">
...
<script type="text/javascript" src="/js/itm-reviewaudit.js"></script>

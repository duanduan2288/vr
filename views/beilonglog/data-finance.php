        ...
        <div class="portlet">
            <div class="portlet-title">
                <div class="caption cap-head">
                    ...
                    <a href="/beilonglog/data-finance">财务明细查询</a>
                </div>
                <div class="tools">
...
<script>
    $(function(){
        ...
        $('#order_download').click(function(event) {
            ...
            window.location.href = '/export/finance?search_domain='+search_domain+'&search_name='+search_name+'&start_date='+start_date+'&end_date='+end_date+'&dtype=csv';
        });
        /***导出excel***/
        $('#order_downloadexcel').click(function(event) {
            ...
            window.location.href = '/export/finance?search_domain='+search_domain+'&search_name='+search_name+'&start_date='+start_date+'&end_date='+end_date+'&dtype=excel';
        });
    });
</script>